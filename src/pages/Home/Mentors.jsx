    ...
    <section className="w-full bg-[#F5F0E6] py-12 md:py-16 border-t border-[#9E743B]/20 relative overflow-hidden text-[#211F1D]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-[80px] space-y-8 sm:space-y-12 relative z-10">
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-4 max-w-4xl mx-auto px-4 py-2">
            {MENTORS.map((m, idx) => (
              <button
                key={m.id}
                onClick={() => setActiveTab(idx)}
                className={`px-5 sm:px-6 py-2.5 rounded-full text-xs font-sans uppercase tracking-[0.15em] font-semibold transition-all duration-300 whitespace-nowrap cursor-pointer ${
                  activeTab === idx
