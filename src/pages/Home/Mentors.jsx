      ...
      <div className="max-w-[1440px] mx-auto px-8 lg:px-[80px] space-y-20">
        ...
        >
          ...
          <div className="bg-[#F3EEE6] border border-[#E0D8CE] p-5 sm:p-8 md:p-12 relative overflow-hidden shadow-sm rounded-sm">
            ...
            <div className="absolute top-3 left-3 w-3 h-3 border-t border-l border-[#8B0000]/40" />
            <div className="absolute top-3 right-3 w-3 h-3 border-t border-r border-[#8B0000]/40" />
            <div className="absolute bottom-3 left-3 w-3 h-3 border-b border-l border-[#8B0000]/40" />
            <div className="absolute bottom-3 right-3 w-3 h-3 border-b border-r border-[#8B0000]/40" />

            <div className="text-center space-y-6">
              <span className="font-serif text-[13px] italic text-[#8B0000] tracking-[0.1em] font-semibold block">
                Saṅkalpa
              </span>
              ...
              <div className="max-w-2xl mx-auto space-y-4 text-left font-serif text-[16px] md:text-[17px] italic text-[#757069] leading-relaxed">
                <p className="relative pl-6">
                  <span className="absolute left-0 text-[#8B0000] font-normal">✦</span>
              ...
              >
                ...
                >
                  <div className="space-y-1.5">
                    <span className="font-serif text-sm italic text-[#8B0000] tracking-[0.05em] font-semibold block">
                      {mentor.plateNo}
                    </span>
                    <span className="font-sans text-[11px] uppercase tracking-[0.25em] text-[#8B0000] font-semibold block">
                      {mentor.role}
                    </span>
                  ...
                  <div className="pt-2">
                    <Link
                      to="/mentors"
                      className="group relative inline-flex items-center gap-1.5 font-sans text-[11px] uppercase tracking-[0.2em] font-semibold text-[#8B0000] hover:text-[#211F1D] transition-colors pb-1"
                    >
                      View Biography Details
                      <span className="transform transition-transform duration-300 group-hover:translate-x-1">→</span>
                      <span className="absolute bottom-0 left-0 w-0 h-[1.5px] bg-[#8B0000] group-hover:w-full transition-all duration-500 ease-out" />
                    </Link>
                  </div>
                </motion.div>
              </div>
