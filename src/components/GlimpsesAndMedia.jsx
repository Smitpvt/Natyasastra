...
const CURATED_MEDIA = [
  // VISUAL HIGHLIGHTS
  {
    id: 'vis-1',
    type: 'visual',
    category: 'Consecration Assembly',
    title: 'Pratiṣṭhā Samāroham Culmination Sabhā',
    subtitle: 'Group Assembly with Dignitaries & Disciples',
    image: '/assets/images/Group photo of performers with dignitaries during the culmination sabha.jpg',
    date: '23 November 2025',
    location: 'Navi Mumbai',
    desc: 'Solemn culmination assembly bringing together Mukhyātithi Prof. K. Ramasubramanian, Smt. Charanya Gurusathya, Dr. Padmaja Suresh, Rohit Viswanath, and distinguished practitioners.',
    tag: 'Featured Visual'
  },
  {
    id: 'vis-2',
    ...
    title: 'Nāma • Rūpa • Nāda • Bindu Intensive',
    subtitle: 'Contemplative & Somatic Sādhanā Circle',
    image: '/assets/images/Participants in the Nama Rupa Nada Bindu immersion.jpg',
    date: 'Recent Immersion',
    location: 'Gurukulam Sanctuary',
    desc: 'Participants and scholars in deep contemplative inquiry, somatic movement reconstruction, and sound-form exploration.',
    tag: 'Featured Visual'
  },
  {
    id: 'vis-3',
