export const PUBLICATIONS = [
  ...
  // I. Civilisational Statecraft Series
  {
    ...
    cover: '/assets/publications/covers/the dharma.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP II- Dharma and the Architecture of Liberty- V4.0.pdf',
    cover: '/assets/publications/covers/dharma architecture.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP III- Good Governance for Growth in Africa.pdf',
    cover: '/assets/publications/covers/Good Governance .webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP IV- Beyond Control- V2.0.pdf',
    cover: '/assets/publications/covers/Beyond Control.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP V- Moral Legitimacy in War From Justification to Dhārmic Alignment- V2.pdf',
    cover: '/assets/publications/covers/Moral Legitmacy in war .webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP VII- Dharmic Ordering of the Cosmic Commons- V2.0 (2).pdf',
    cover: '/assets/publications/covers/A Systems Theory of Scoial order.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP VII- Dharmic Ordering of the Cosmic Commons- V2.0 (1).pdf',
    cover: '/assets/publications/covers/Dharmic Ordering.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP VIII- Making Democracy More Governable- V1.pdf',
    cover: '/assets/publications/covers/Making Democracy more Governable.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP IX- Order From Within- V1.pdf',
    cover: '/assets/publications/covers/Order From Within.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Statecraft Series',
    ...
    file: '/assets/publications/WP X- Dharma from Discipline to Paricipation- V1.pdf',
    cover: '/assets/publications/covers/Dharma From Disciplane to Participation.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  ...
  // II. Research Programme – Civilisational Governance
  {
    ...
    file: '/assets/publications/CG01 The Dharma Doctrine of Disciplined Equilibrium.pdf',
    cover: '/assets/publications/covers/The Dharma Doctrine Of Disciplined Equilibrium.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Governance',
    ...
    cover: '/assets/publications/covers/From Doctrine To Practice .webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Governance',
    ...
    cover: '/assets/publications/covers/Beyound CSR and ESG.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Governance',
    ...
    file: '/assets/publications/CG-CDR-02 Executive Compensation in Corporate Dharma Rājyam.pdf',
    cover: '/assets/publications/covers/Excutive Compensation in Corporate Dharma Rajyam.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Civilisational Governance',
    ...
    file: '/assets/publications/CG-EWP01-Executive Compensation Beyond Market Benchmarks.pdf',
    cover: '/assets/publications/covers/Excutive compensation Beyond Market Benchmarks.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  ...
  // III. Civilisational Statecraft Series – Aesthetic Knowledge Systems
  {
    ...
    file: '/assets/publications/CSS-AKS WP I- The Return of Nāṭya- V1.pdf',
  ...
  },
  {
    ...
    file: '/assets/publications/CSS-AKS-WP II- Rasika–Saṃskṛti–Saṃvāda- V1.pdf',
    cover: '/assets/publications/covers/Rasika Samskrit Samvada.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  ...
  // IV. Rasa Reflection Series
  {
    ...
    file: '/assets/publications/NG-RR-01From Entitlement to Embodiment.pdf',
    cover: '/assets/publications/covers/From Entitlement to Embodiment.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  },
  {
    series: 'Rasa Reflection Series',
    ...
    file: '/assets/publications/NG-RR-02 From Examinations to Education.pdf',
    cover: '/assets/publications/covers/From Examinations to Education.webp',
    theme: 'bg-gradient-to-br from-accent-bronze to-[#462814] text-[#F3EEE6] border border-[#462814]/40 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]'
  }
];
